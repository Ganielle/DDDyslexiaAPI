...
exports.savescore = async (req, res) => {
    ...
    await Writeit.findOneAndUpdate({owner: new mongoose.Types.ObjectId(id), letter: letter, difficulty: difficulty}, {score: score})
    .catch(async err => {
...
exports.getchildscore = async (req, res) => {
    ...
    const writeitdata = await Writeit.find({owner: new mongoose.Types.ObjectId(childid), difficulty: difficulty})
    .then(data => data)
    .catch(async err => {
